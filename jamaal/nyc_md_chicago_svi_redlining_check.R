...
nyc_bmore_chicago <- rbind(nyc_covid_svi, baltimore_svi_covid, chicago_svi_covid)

st_geometry(nyc_bmore_chicago) <- "MULTIPOLYGON"

st_write(nyc_bmore_chicago, "jamaal/data/covid_redling_combined_files/baltimore_nyc_chicago_combined.gpkg", append = FALSE)
